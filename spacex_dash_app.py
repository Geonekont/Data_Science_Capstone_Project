...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Successful number of all sites')
        return fig
    else:
        selected_name = spacex_df.loc[spacex_df['Launch Site'] == entered_site]
        fig=px.pie(data_frame=selected_name,values='class',names='class',title=f"Total Success Launches for site {entered_site}")
        return fig
